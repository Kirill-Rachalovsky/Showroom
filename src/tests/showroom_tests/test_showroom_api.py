...
detail_url = "/api/v1/showroom/detail/"
...
def test_dealer_details(client, auth_client, admin_customer, details_responses, post_responses):
    ...
    assert details_responses(client=auth_client, url=url, model=Showroom, payload=payload) == 200
    assert details_responses(client=auth_client, url=detail_url, model=Showroom, payload=payload) == 403
    assert details_responses(client=admin_customer, url=detail_url, model=Showroom, payload=payload) == 200
...
def test_dealer_delete(client, auth_client, admin_customer, delete_responses, post_responses):
    ...
    assert delete_responses(client=client, url=detail_url, model=Showroom, payload=payload) == 403
    assert delete_responses(client=auth_client, url=detail_url, model=Showroom, payload=payload) == 403
    assert delete_responses(client=admin_customer, url=detail_url, model=Showroom, payload=payload) == 204
